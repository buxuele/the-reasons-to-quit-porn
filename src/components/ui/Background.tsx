  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden bg-background transition-colors duration-500">
      ...
      <div 
        ...
        style={{
            background: 'radial-gradient(circle at 50% 0%, rgba(20, 90, 124, 0.6) 0%, rgba(20, 90, 124, 0.1) 40%, transparent 70%)'
        }}
      ></div>
      ...
      <div className="absolute top-[10%] left-[-10%] w-[800px] h-[800px] bg-[#145A7C]/30 rounded-full blur-[120px] animate-pulse-glow"></div>
      <div className="absolute bottom-[-20%] right-[-10%] w-[1000px] h-[1000px] bg-[#0f4a63]/40 rounded-full blur-[140px] animate-pulse-glow" style={{ animationDelay: '3s' }}></div>
